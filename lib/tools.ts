...
export const tools: Tool[] = [
  {
    ...
    description: 'Randomly pick a winner from Instagram comments for giveaways and contests.',
    longDescription: 'Paste comments from any Instagram post and randomly select a winner for your giveaway or contest. Filter duplicates, set minimum word count, and watch the animated selection process.',
    category: 'instagram',
    icon: 'Gift',
    metaTitle: 'Free Instagram Comment Picker — Random Winner Generator | SocialKit',
    metaDescription: 'Pick a random winner from Instagram comments for giveaways and contests. Paste comments, filter duplicates, and select winners with animation. Free, no sign-up.',
    faq: [
      { q: 'How does the comment picker work?', a: 'Paste your Instagram comments into the text area, configure your filters (remove duplicates, minimum word count), and click Pick Winner. The tool randomly selects a comment using a cryptographically secure random number generator.' },
      { q: 'Do I need to log in to Instagram?', a: 'No. Simply copy and paste the comments from your Instagram post. The tool works entirely in your browser with no API calls or logins required.' },
    ...
    howTo: [
      'Go to the Instagram post with comments for your giveaway.',
      'Copy all the comments from the post (select and copy the text).',
      'Paste the comments into the text area on this tool.',
      'Configure filters: remove duplicate usernames, set minimum word count if needed.',
      'Set the number of winners you want to pick.',
      'Click "Pick Winner" and watch the animated selection.',
      'Screenshot or note down the winner(s).',
    ],
  },
  {
  ...
  },
  {
    ...
    description: 'Calculate your engagement rate and compare to industry benchmarks.',
    longDescription: 'Enter your follower count and average engagement metrics (likes, comments, shares) to calculate your engagement rate. Compare against industry benchmarks by platform and niche.',
    category: 'cross-platform',
    icon: 'TrendingUp',
    metaTitle: 'Free Engagement Rate Calculator — With Industry Benchmarks | SocialKit',
    metaDescription: 'Calculate your social media engagement rate. Enter followers, likes, comments, and compare to industry benchmarks. Free calculator.',
    faq: [
    ...
    howTo: [
      ...
      'View your calculated engagement rate.',
      'Compare your rate against industry benchmarks.',
      'See recommendations for improving your engagement.',
    ],
  },
];
